...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _indexes = __webpack_require__(9);
	  ...
	  _createClass(EmojidexCategories, [{
	    ...
	    value: function _get_category(callback, locale) {
	      ...
	      return $.ajax({
	        ...
	        _this4._categories = response.categories;
	        return _this4.EC.Data.categories(response.categories).then(function () {
	          if (typeof callback === 'function') {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _crossStorage = __webpack_require__(5);
	...
	var EmojidexDataStorage = function () {
	  function EmojidexDataStorage() {
	    ...
	    this.hub = new _crossStorage.CrossStorageClient(hub_path, { frameId: 'emojidex-client-storage-hub' });
	    this.hub_cache = {};
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _favorites = __webpack_require__(12);
